...
const Four_PII_About = require("../models/4pii_Grafics_Head");
const krislin_About = require("../models/Krislin_grafics_head");
const LLC_About = require("../models/LLC_Grafics_Head");
const saas_About = require("../models/99ideasSaas/saas_GraphicsHead");
...
module.exports.Add_4pii = async (req, res) => {
  try {
    ...
    await data.save();
    res.json({ message: "about _4pii_Grafics_data", data });
    console.log(data);
  } catch (error) {
    res.send(error);
    console.log(error);
