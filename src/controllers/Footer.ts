...
const Four_PII_About = require("../models/4pii_footer");
const krislin_About = require("../models/krislin_grafic");
const LLC_About = require("../models/LLC_Footer");
// const LLC_About = require("../models/homePage_footer");
const saas_About = require("../models/99ideasSaas/saas_Footer");
const LLP_About = require("../models/LLP_grafic");
...
module.exports.Add_4pii = async (req, res) => {
  try {
    ...
    await data.save();
    res.json({ message: "about _4pii_data_footer_page", data });
    console.log(data);
  } catch (error) {
    res.send(error);
    console.log(error);
...
module.exports.Add_LLC_Footer = async (req, res) => {
  try {
...
module.exports.get_LLC_Footer = asyncMiddleware(async (req, res) => {
  try {
    let getData = await LLC_About.find();
    return res.status(200).send(getData);
  } catch (error) {
