...
const Four_PII_About = require("../models/4pii_Testimonial");
const krislin_About = require("../models/krislin_onlienAdmission");
const LLC_About = require("../models/99ideasLLS_Testimonial");
const saas_About = require("../models/99ideasSaas/saas_Testimonial");
...
module.exports.Add_4pii = async (req, res) => {
  try {
    ...
    const data = await Four_PII_About.create({
      ...
      info_one: req.body.info_one,
      info_two: req.body.info_two,
    });
