...
const Four_PII_About = require("../models/4pii_Elerning");
const krislin_About = require("../models/krislin_Elerning");
const LLC_About = require("../models/LLC_Elerning");
const saas_About = require("../models/99ideasSaas/saas_Elearning");
const LLP_About = require("../models/LLP_Elerning");
...
module.exports.Add_4pii = async (req, res) => {
  try {
    const data = await Four_PII_About.create({
      ...
      content_head1: req.body.content_head1,
