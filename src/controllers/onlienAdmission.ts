...
const Four_PII_About = require("../models/4pii_onlienAdmission");
const krislin_About = require("../models/krislin_onlienAdmission");
const LLC_About = require("../models/LLC_onlienAdmission");
const saas_About = require("../models/99ideasSaas/saas_OnlineAdmission");
