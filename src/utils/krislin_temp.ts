...
exports.verificationEmailTemplate = (name, email , date) => {
...
<html lang="en">
  ...
  <body>
     <div>
      <h3>Dear ${name} you have contact us in successfully using your email which is ${email}</h3>
     </div>
     <br>
     <br>
      <footer><h4>Thanks and Regards Krislin Consultants LLP </h4></footer>
  </body>
</html>
`;
  return template;
